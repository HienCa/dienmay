 ...
 * @author PC
 */
@WebServlet(urlPatterns = {"/FindEmployeeServlet"})
public class FindEmployeeServlet extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        String findEmployee = request.getParameter("findEmployee");
        Connection con = null;
        try {
            con = MySQLConntUtils.getMySQLConnection();
            ArrayList<Employee> list = DBUtils.AllEmployee(con, findEmployee);
