...
public class UpdateOrderServlet extends HttpServlet {
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            Order order = DBUtils.OneOrder(conn, OrderCode);
    ...
    protected void doPost(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            /*if (orderCode.length() < 4 || orderCode.length() > 10) {
                ...
                DBUtils.UpdateOrder(con, order);
                request.setAttribute("success", "Successfull Update!...");
                request.getRequestDispatcher("/Orders.jsp").forward(request, response);
            } else {
                request.setAttribute("e", "Update failed!... Không tìm thấy đơn đặt hàng có mã là " + orderCode);
                request.getRequestDispatcher("/UpdateOrder.jsp").forward(request, response);
            }
