 ...
 * @author PC
 */
@WebServlet(urlPatterns = {"/InsertCustomerServlet"})
public class InsertCustomerServlet extends HttpServlet {
    ...
    protected void doPost(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            Customer customer = new Customer( Fullname, DateOfBirth, Gender, Email, Tel, CCCD, Address);
           ...
           /* if (CustomerCode.length() < 4 || CustomerCode.length() > 10) {
                ...
                request.setAttribute("e", "Khách hàng có mã là: " + "'" + CustomerCode + "'" + " đã tồn tại.");
                request.getRequestDispatcher("/InsertCustomer.jsp").forward(request, response);
            } */else {
                DBUtils.insertCustomer(con, customer);
